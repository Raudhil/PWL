        ...
        <tbody>
            @foreach ($penjualans as $penjualan)
                <tr>
                    ...
                    <td class="text-center">{{ $penjualan->penjualan_id }}</td>
                    <td>{{ $penjualan->pembeli ?? '-' }}</td>
                    <td class="text-center">{{ $penjualan->penjualan_kode }}</td>
                    <td>{{ $penjualan->user->nama ?? '-' }}</td>
                    <td class="text-center">
                        {{ \Carbon\Carbon::parse($penjualan->penjualan_tanggal)->format('d-m-Y H:i:s') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
