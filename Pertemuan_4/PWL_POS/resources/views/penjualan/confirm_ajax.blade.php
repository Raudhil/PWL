            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            <th class="text-right col-4">Penjualan ID:</th>
                            <td class="col-8">{{ $penjualan->penjualan_id }}</td>
                        </tr>
                        <tr>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                tablePenjualan.ajax.reload(); // pastikan DataTable penjualan bernama tablePenjualan
                            } else {
                                Swal.fire({
                                    icon: 'error',
