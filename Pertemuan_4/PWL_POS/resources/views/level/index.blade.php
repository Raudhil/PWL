    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ url('/level/export_pdf') }}" class="btn btn-sm btn-warning mt-1"><i class="fa fa-filepdf"></i>
                    Export
                    Level</a>
                <button onclick="modalAction('{{ url('/level/import') }}')" class="btn btn-sm mt-1 btn-info">Import
                    Level</button>
