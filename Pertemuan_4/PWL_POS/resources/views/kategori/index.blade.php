    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ url('/kategori/export_pdf') }}" class="btn btn-sm btn-warning mt-1"><i class="fa fa-filepdf"></i>
                    Export
                    Kategori</a>
                <button onclick="modalAction('{{ url('/kategori/import') }}')" class="btn btn-sm mt-1 btn-info">Import
                    Kategori</button>
